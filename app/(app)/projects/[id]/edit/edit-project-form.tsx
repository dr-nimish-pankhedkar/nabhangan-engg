...
export default function EditProjectForm({
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      flat_facing: str(m.flat_facing),
      flat_boundary_east: str(m.flat_boundary_east),
      flat_boundary_west: str(m.flat_boundary_west),
      flat_boundary_north: str(m.flat_boundary_north),
      flat_boundary_south: str(m.flat_boundary_south),
