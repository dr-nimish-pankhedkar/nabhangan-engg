...
export default function PrintClient({ projectId, userId }: { projectId: string; userId: string }) {
  ...
  async function onTimeSubmit(data: any) {
    const result = await logTime({ projectId, userId, stage: "print", hours_spent: parseFloat(data.hours_spent), notes: data.notes || null });
