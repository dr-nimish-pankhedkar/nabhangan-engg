...
export default function ThirdPartySurveyClient({
  accessToken,
  projectId,
  project,
  existingReport,
      ...
      <Card className="border-green-200 bg-green-50">
        <CardContent className="py-10 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-green-700 max-w-sm">
            Your site visit report has been submitted successfully. The office has been notified. You may close this page.
          </p>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Form {...form}>
      <div className="space-y-4">
        ...
        <Card className="border-slate-200">
          <CardHeader className="py-3 px-4 pb-0">
            <CardTitle className="text-sm text-[#1e3a5f] font-semibold">Case Information</CardTitle>
          </CardHeader>
          <CardContent className="px-4 pb-4 pt-3">
            ...
            <div className="mt-3 pt-3 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
              ...
              {project.latitude && project.longitude && (
                <ReadOnlyRow label="Tentative GPS" value={`${project.latitude}, ${project.longitude}`} />
              )}
            </div>
          </CardContent>
        </Card>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  {uploadingCount > 0
                    ...
                    : `Add Photos (${remaining} slot${remaining !== 1 ? "s" : ""} left)`}
                </Button>
